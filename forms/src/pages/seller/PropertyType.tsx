...
function SelectionCard({
  ...
  return (
    ...
    >
      <div
        className={`
          ...
          ${selected 
            ...
            : 'bg-white border-[#E4E7EC] shadow-[inset_0_1px_2px_rgba(15,27,46,0.05)] group-hover:border-[#C89B3C]'
          }
        `}
      >
        {selected && (
      ...
      <div className={`
        relative flex items-center justify-center w-7 h-7 transition-colors duration-200 ease
        ${selected ? 'text-[#E6C36A]' : 'text-[#667085] group-hover:text-[#C89B3C]'}
      `}>
        <Icon size={24} strokeWidth={1.5} />
        {isAdd && (
          <div className={`
            absolute -bottom-1 -right-1 text-white rounded-full p-0.5 flex items-center justify-center transition-all duration-200 ease
